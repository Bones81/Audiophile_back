...
ALLOWED_HOSTS = ['localhost', 'young-savannah-30515.herokuapp.com', 'audiophile-back.onrender.com']
...
CSRF_TRUSTED_ORIGINS = ['http://localhost:3000', 'https://murmuring-forest-19651.herokuapp.com']
